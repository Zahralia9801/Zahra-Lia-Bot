...
/////////////////
const BotName = '𝗟𝗘𝗘𝗔 𝗕𝗢𝗧'; 
const instagram = 'https://instagram.com/itsmelia.zhr?igshid=1ij67rilfpltz'; 
const telegram = ''; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = '';
//const grupch1 = 'https://chat.whatsapp.com/FkjGRpLC4IUCtsQ2epsfPl'; 
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@itsmelia.zhr`)
})
